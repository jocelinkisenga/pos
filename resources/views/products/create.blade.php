                ...
                <div class="card-body">
                    ...
                    @csrf
                        ...
                        <div class=" row align-items-center">
                            ...
                            <div class="form-group col-md-6">
                                <label for="product_garage">depot produit </label>
                            ...
                            <div class="form-group col-md-6">
                                <label for="product_store">Magazin produit</label>
                            ...
                            <div class="form-group col-md-6">
                                <label for="selling_price">Prix de vent <span class="text-danger">*</span></label>
